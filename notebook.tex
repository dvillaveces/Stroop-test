...
choices.}\label{what-is-an-appropriate-set-of-hypotheses-for-this-task-specify-your-null-and-alternative-hypotheses-and-clearly-define-any-notation-used.-justify-your-choices.}}
    ...
    The appropriate hypotheses are: \[ H_{0}:t_{i} - t_{c} = 0\]
\[ H_{A}:t_{i} - t_{c}\neq 0\] where \(t_{c}\) is the mean time taken to
read the congruent list (in seconds) and \(t_{i}\) is the mean time
taken to read the incongruent list (in seconds).
